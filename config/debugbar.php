...
return [
     ...
     */
    'storage' => [
        'enabled' => env('DEBUGBAR_STORAGE_ENABLED', false), // REQUERIDO: Habilitado para evitar problemas de memoria con headers grandes
    ...
    */
    ...
    'collectors' => [
        ...
        'models' => env('DEBUGBAR_COLLECTORS_MODELS', false),           // Deshabilitado para reducir memoria (puede capturar modelos grandes)
    ...
    'options' => [
        ...
        'db' => [
            'with_params' => env('DEBUGBAR_OPTIONS_WITH_PARAMS', false),   // Deshabilitado para reducir memoria
            'exclude_paths' => [       // Paths to exclude entirely from the collector
                // 'vendor/laravel/framework/src/Illuminate/Session', // Exclude sessions queries
            ],
            'backtrace' => env('DEBUGBAR_OPTIONS_DB_BACKTRACE', false),   // Deshabilitado para reducir memoria
            ...
            'only_slow_queries' => env('DEBUGBAR_OPTIONS_DB_ONLY_SLOW_QUERIES', false), // Mostrar todas las queries
            ...
            'soft_limit' => (int) env('DEBUGBAR_OPTIONS_DB_SOFT_LIMIT', 50),  // Reducido para capturar menos datos
            'hard_limit' => (int) env('DEBUGBAR_OPTIONS_DB_HARD_LIMIT', 200),  // Reducido para evitar demasiadas queries
        ],
        'mail' => [
        ...
        'views' => [
            'timeline' => env('DEBUGBAR_OPTIONS_VIEWS_TIMELINE', false),                  // Deshabilitado para reducir memoria
            'data' => env('DEBUGBAR_OPTIONS_VIEWS_DATA', false),                         // Mantener en false para no capturar datos de vistas
