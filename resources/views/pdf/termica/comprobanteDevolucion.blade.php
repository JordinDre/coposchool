...
<body>
    ...
    <div class="documento-titulo">COMPROBANTE DE DEVOLUCIÓN #{{ $venta->id }}</div>
    ...
    <div class="salto">
        ...
        <div class="info-line"><strong>Estado:</strong> {{ ucfirst(str_replace('_', ' ', $venta->estado)) }}</div>
    </div>
    ...
    @if($venta->motivo)
    <div class="salto">
        <div style="font-weight: bold; font-size: 9px;">MOTIVO DE DEVOLUCIÓN:</div>
        <div style="font-size: 8px;">{{ $venta->motivo }}</div>
    </div>
    @endif
