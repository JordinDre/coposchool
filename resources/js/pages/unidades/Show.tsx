                ...
                <div className="flex items-start justify-between">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            <Badge variant="outline" className="font-mono text-base px-3 py-1">{unidad.orden}</Badge>
                        ...
                        {typeof unidad.notas_count === 'number' && (
                            <p className="text-sm"><span className="font-medium">{unidad.notas_count}</span> notas registradas</p>
                        )}
                    </div>
